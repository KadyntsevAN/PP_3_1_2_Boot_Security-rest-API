...
import ru.kata.PP_3_1_2_Boot_SecurityrestAPI.model.User;
...
public class UserClient {
    ...
    public static void deleteUser(String cookie) {
    ...
    public static String saveUser(String cookie) {
        ...
        System.out.println("Status Code: " + statusCode);
        System.out.println("Response Body: " + responseBody);
        ResponseEntity<List<User>> responseEntity2 = restTemplate.exchange("http://94.198.50.185:7081/api/users", HttpMethod.GET, null, new ParameterizedTypeReference<List<User>>() {
        });
    ...
    public static void editUser(String cookie) {
        String url = "http://94.198.50.185:7081/api/users";
